...
# iam 配置
readonly IAM_DATA_DIR=${IAM_DATA_DIR:-/Users/yinhuile/iam-data/data/iam} # iam 各组件数据目录
readonly IAM_INSTALL_DIR=${IAM_INSTALL_DIR:-/Users/yinhuile/iam-data/opt/iam} # iam 安装文件存放目录
readonly IAM_CONFIG_DIR=${IAM_CONFIG_DIR:-/Users/yinhuile/iam-data/etc/iam} # iam 配置文件存放目录
readonly IAM_LOG_DIR=${IAM_LOG_DIR:-/Users/yinhuile/iam-data/var/log/iam} # iam 日志文件存放目录
